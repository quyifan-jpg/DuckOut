...
static void InitDefaultsscc_info_AddRequest_add_5fsimple_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AddRequest_add_5fsimple_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AddRequest_add_5fsimple_2eproto}, {}};

static void InitDefaultsscc_info_AddResponse_add_5fsimple_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AddResponse_add_5fsimple_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AddResponse_add_5fsimple_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_add_5fsimple_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_add_5fsimple_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_add_5fsimple_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_add_5fsimple_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::calculator::AddRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::calculator::AddRequest, a_),
  PROTOBUF_FIELD_OFFSET(::calculator::AddRequest, b_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_add_5fsimple_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020add_simple.proto\022\ncalculator\"\"\n\nAddReq"
  "uest\022\t\n\001a\030\001 \001(\005\022\t\n\001b\030\002 \001(\005\"\035\n\013AddRespons"
  "e\022\016\n\006result\030\001 \001(\0052F\n\nCalculator\0228\n\003Add\022\026"
  ".calculator.AddRequest\032\027.calculator.AddR"
  "esponse\"\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_add_5fsimple_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_add_5fsimple_2eproto_sccs[2] = {
  &scc_info_AddRequest_add_5fsimple_2eproto.base,
  &scc_info_AddResponse_add_5fsimple_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_add_5fsimple_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_add_5fsimple_2eproto = {
  false, false, descriptor_table_protodef_add_5fsimple_2eproto, "add_simple.proto", 177,
  &descriptor_table_add_5fsimple_2eproto_once, descriptor_table_add_5fsimple_2eproto_sccs, descriptor_table_add_5fsimple_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_add_5fsimple_2eproto::offsets,
  file_level_metadata_add_5fsimple_2eproto, 2, file_level_enum_descriptors_add_5fsimple_2eproto, file_level_service_descriptors_add_5fsimple_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_add_5fsimple_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_add_5fsimple_2eproto)), true);
namespace calculator {
...
const AddRequest& AddRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_AddRequest_add_5fsimple_2eproto.base);
...
const AddResponse& AddResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_AddResponse_add_5fsimple_2eproto.base);
  return *internal_default_instance();
}
